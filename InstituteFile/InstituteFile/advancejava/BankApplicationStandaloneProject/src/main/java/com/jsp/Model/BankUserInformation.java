...
public class BankUserInformation 
{
	...
	public BankUserInformation() {
		
	}
	public BankUserInformation(int userId, String username, String userMobileNo, String userMailId, String userAddress,
	...
	public String toString() {
		return "BankUserInformation [userId=" + userId + ", username=" + username + ", userMobileNo=" + userMobileNo
