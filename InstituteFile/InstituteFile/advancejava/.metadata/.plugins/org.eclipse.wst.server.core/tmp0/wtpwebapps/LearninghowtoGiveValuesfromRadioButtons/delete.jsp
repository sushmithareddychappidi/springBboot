...
<center>
     ...
     {%>
    	...
    	<td><input value="<%= rs.getInt(1) %>" name="id" hidden="true"><button>update</button></td>
    	<td><input value="<%= rs.getInt(1) %>" name="ID" hidden="trur"><button>delete</button></td>
    	</form>
    	</tr>
    	</table>
