...
public class ProductDriverClass 
{
	...
	public void updateProductCostBasedOnProductId(int newCost,int Pid)
	{
	...
	public static void main(String[] args) 
	{
		...
		while(start)
		{
			System.out.println("Enter The Choice: 1)add 2)displatProduct 3)displayPIdPNamebasedOnCost 4)updateProductCostBasedOnProductId 5)removeProductBasedOnExpireDate");
			int ch=sc.nextInt();
			switch(ch)
			{
			case 1:
			...
			case 4:
			{
				...
				try
				{
					p.updateProductCostBasedOnProductId(cost, pid);
					break;
				}
