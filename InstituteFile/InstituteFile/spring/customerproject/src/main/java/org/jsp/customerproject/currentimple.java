...
public class currentimple implements Addressinterface
{
	...
	public currentimple() 
	{
		System.out.println("No argument constructor of current address");		
	}
	...
	public String toString() {
		return "currentimple [doorno=" + doorno + ", streetno=" + streetno + ", area=" + area + ", landmark="
