...
public class Hoodieimple implements ProductInterface
{
	private String type;
	...
	public Hoodieimple() {
		System.out.println("No argument constructor of Hoodie");
	}
	...
	public String toString() {
		return "Hoodieimple [type=" + type + ", color=" + color + ", cost=" + cost + ", quantity=" + quantity + ", size="
				+ size + "]";
	}
	@Override
	public void getInfo() {
